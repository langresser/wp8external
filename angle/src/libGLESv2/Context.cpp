...
{
    mResourceManager->checkBufferAllocation(buffer, 0);
...
{
    mResourceManager->checkBufferAllocation(buffer, 1);
...
void Context::applyTextures(SamplerType type)
{
    ...
    int samplerCount = MAX_TEXTURE_IMAGE_UNITS;
