...
ID3D11SamplerState *RenderStateCache::getSamplerState(const gl::SamplerState &samplerState)
{
    ...
    else
    {
        ...
        samplerDesc.MinLOD = 0;//gl_d3d11::ConvertMinLOD(samplerState.minFilter, samplerState.lodOffset);
        samplerDesc.MaxLOD = FLT_MAX;		// MaxLOD must be FLT_MAX at feature level 9.*;//gl_d3d11::ConvertMaxLOD(samplerState.minFilter, samplerState.lodOffset);
